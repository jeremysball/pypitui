...
class TestMatchesKeyKittyProtocol:
    ...
    def test_ctrl_c_cyrillic_with_base_layout(self):
        """Match Ctrl+c when pressing Ctrl+С (Cyrillic) with base layout key."""
    ...
    def test_ctrl_d_cyrillic_with_base_layout(self):
        """Match Ctrl+d when pressing Ctrl+В (Cyrillic) with base layout key."""
        set_kitty_protocol_active(True)
    ...
    def test_ctrl_z_cyrillic_with_base_layout(self):
        """Match Ctrl+z when pressing Ctrl+Я (Cyrillic) with base layout key."""
        set_kitty_protocol_active(True)
...
class TestParseKeyLegacy:
    ...
    def test_parse_single_printable(self):
        ...
        assert parse_key("Z") == "z"  # lowercase
    ...
    def test_parse_unknown_returns_none(self):
        ...
        assert parse_key("\x1b[XYZ") is None
