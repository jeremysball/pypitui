...
### Fixed
- Added `CURSOR_MARKER` to exports.
- Simplified rendering loop by dropping unused tracking of hardware cursor variables.
- Updated `TypeStubs` reflecting changes introduced in `0.4.0`.
